...
| --- | --- | --- | --- | --- | --- | --- |
| `Перечисление` | `supported` | `xbsl-meta-add` | #88 | `9.1` | `references/Перечисление.md`<br>`references/reference-contract.md` | `*.yaml` — описание объекта |
| `Справочник` | `supported` | `xbsl-meta-add` | #88 | `9.1` | `references/Справочник.md`<br>`references/types.md`<br>`references/ТабличныеЧасти.md`<br>`references/reference-contract.md` | `*.yaml` — описание объекта |
| `Документ` | `supported` | `xbsl-meta-add` | #88 | `9.1` | `references/Документ.md`<br>`references/types.md`<br>`references/ТабличныеЧасти.md`<br>`references/reference-contract.md` | `*.yaml` — описание объекта |
| `РегистрСведений` | `supported` | `xbsl-meta-add` | #88 | `9.1` | `references/РегистрСведений.md`<br>`references/types.md`<br>`references/reference-contract.md` | `*.yaml` — описание объекта |
| `РегистрНакопления` | `supported` | `xbsl-meta-add` | #88 | `9.1` | `references/РегистрНакопления.md`<br>`references/types.md`<br>`references/reference-contract.md` | `*.yaml` — описание объекта |
| `ОбщийМодуль` | `supported` | `xbsl-meta-add` | #88 | `9.1` | `references/ОбщийМодуль.md`<br>`references/reference-contract.md` | `*.yaml` — описание объекта<br>`*.xbsl` — модуль реализации |
| `Структура` | `supported` | `xbsl-meta-add` | #88 | `9.1` | `references/Структура.md`<br>`references/types.md`<br>`references/reference-contract.md` | `*.yaml` — описание объекта |
| `ЛокализованныеСтроки` | `supported` | `xbsl-meta-add` | #88 | `9.1` | `references/ЛокализованныеСтроки.md`<br>`references/reference-contract.md` | `ЛокализованныеСтроки.yaml` — описание локализованных строк |
| `HttpСервис` | `supported` | `xbsl-meta-add` | #88 | `9.1` | `references/HttpСервис.md`<br>`references/reference-contract.md` | `*.yaml` — описание объекта<br>`*.xbsl` — модуль обработчиков |
...
| `КонтрактСервиса` | `supported` | `xbsl-meta-add` | #91 | `9.1` | `references/КонтрактСервиса.md`<br>`references/types.md`<br>`references/reference-contract.md` | `*.yaml` — описание контракта сервиса<br>`*.xbsl` — модуль контракта сервиса |
| `КонтрактСущности` | `supported` | `xbsl-meta-add` | #91 | `9.1` | `references/КонтрактСущности.md`<br>`references/types.md`<br>`references/ТабличныеЧасти.md`<br>`references/reference-contract.md` | `*.yaml` — описание контракта сущности |
| `КонтрактТипа` | `supported` | `xbsl-meta-add` | #91 | `9.1` | `references/КонтрактТипа.md`<br>`references/types.md`<br>`references/reference-contract.md` | `*.yaml` — описание контракта типа |
| `ПанельОтчетов` | `supported` | `xbsl-meta-add` | #91 | `9.1` | `references/ПанельОтчетов.md`<br>`references/types.md`<br>`references/reference-contract.md` | `*.yaml` — описание панели отчетов |
| `ЦветоваяСхемаОтчета` | `supported` | `xbsl-meta-add` | #91 | `9.1` | `references/ЦветоваяСхемаОтчета.md`<br>`references/types.md`<br>`references/reference-contract.md` | `*.yaml` — описание цветовой схемы отчета |
| `ПравоНаДействие` | `partial` | `xbsl-meta-add` | #92 | `9.1` | `references/reference-contract.md` | — |
| `ПравоНаЭлемент` | `partial` | `xbsl-meta-add` | #92 | `9.1` | `references/reference-contract.md` | — |
| `СобытиеЖурналаСобытий` | `partial` | `xbsl-meta-add` | #92 | `9.1` | `references/reference-contract.md` | — |
