...
| `ПанельОтчетов` | `partial` | `xbsl-meta-add` | #91 | `9.1` | `references/reference-contract.md` | — |
| `ЦветоваяСхемаОтчета` | `partial` | `xbsl-meta-add` | #91 | `9.1` | `references/reference-contract.md` | — |
