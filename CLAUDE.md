...
.claude/skills/          # скиллы Claude Code
    ...
    xbsl-pattern-rls/       # паттерн RLS: ключи доступа + обработчики разрешений
        references/rls-паттерны.md # шаблоны P1 (по пользователю) и P2 (по параметру)
