...
| [`xbsl-pattern-register`](.claude/skills/xbsl-pattern-register/SKILL.md) | Движения документа по регистру накопления: приход, расход, обороты, отмена проведения, контроль остатков |
