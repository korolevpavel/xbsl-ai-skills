...
Использование:
    {python} skills/xbsl-explore/scripts/explore.py [--type ВидЭлемента] [--name ИмяОбъекта] [--root /path]

Примеры:
    {python} skills/xbsl-explore/scripts/explore.py --root cc
    {python} skills/xbsl-explore/scripts/explore.py --type Справочник --root cc
    {python} skills/xbsl-explore/scripts/explore.py --type Документ --name Заказы --root cc
"""
