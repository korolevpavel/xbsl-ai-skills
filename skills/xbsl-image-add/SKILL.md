...
На target 10.0+ при загрузке фото и особенно при P6 прочитай `../xbsl-file-add/references/file-names-10.md`. Используй имя загруженного объекта; режим исправления имён общий для приложения и не изменяется в обработчике фото.
...
Перед созданием обработчика прочитай `docs/xbsl-spec.md`.
