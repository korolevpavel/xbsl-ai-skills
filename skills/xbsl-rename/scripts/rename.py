...
Использование (dry-run — только показывает изменения):
    {python} skills/xbsl-rename/scripts/rename.py --old-name Номенклатура --new-name Товары [--root .]

Применить изменения:
    {python} skills/xbsl-rename/scripts/rename.py --old-name Номенклатура --new-name Товары [--root .] --apply
"""
